...
const careers = ["Student", "Coder", "Web Developer", "Intelligent student"]; // create a array to assign the options
...
function uptdate() {  // creating a functions for loop the proceess
    ...
    containerE.innerHTML = `<h1>I am  ${careers[careers_index].slice(0,1) === 'I'?'an':'a'} ${careers[careers_index].slice(0, charcter_index)} </h1>`;
